scoreboard players set @s[tag=dafi.steel.drop.primed] delta.addition.magnitude 12000
execute at @s[tag=dafi.steel.drop.primed] rotated ~ -20 run function dafi:internal/mechanics/addition/add_motion
...
execute at @s run particle damage_indicator ~ ~ ~ 4 0 4 1 50 normal
