...
execute positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[dx=1,tag=!dafi.shade.hit] positioned ~0.4 ~0.4 ~0.4 at @s run playsound minecraft:block.note_block.hat master @a ~ ~ ~ 1 0.5
