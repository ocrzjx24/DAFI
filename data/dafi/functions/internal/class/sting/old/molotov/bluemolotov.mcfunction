# execute if score @s dafi.sting.spectral matches 1.. as @e[distance=..1.5, team=!blue] run damage @s 6.0
execute if score @s dafi.sting.spectral matches 1.. run scoreboard players set @a[distance=..1.5, team=!blue] dafi.slow.check 1
execute if score @s dafi.sting.spectral matches 1.. run particle dust 0.145 0.588 0.929 1.5 ~ ~ ~ 0.5 0.1 0.5 0.2 1 force
execute if score @s dafi.sting.spectral matches 1.. run particle dust 0.396 1 0.898 1 ~ ~ ~ 0.7 0.2 0.7 0.5 1 force
