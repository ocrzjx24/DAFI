...
execute unless predicate dafi:is_sneaking if score @s dafi.sting.dropStick matches 1 run tag @s remove dafi.offhandProcessed
...
execute if score @s dafi.sting.useEgg matches 1 run scoreboard players reset @s dafi.offhandReady
execute if score @s dafi.sting.useEgg matches 1.. run scoreboard players reset @s dafi.sting.useEgg
execute if score @s dafi.sting.useSnowball matches 1 run scoreboard players reset @s dafi.offhandReady
...
## dafi.sting.gCD
execute if score @s dafi.sting.gCD matches 60 run playsound minecraft:entity.shulker.open master @s ~ ~ ~ 6000 1 1
execute if score @s dafi.sting.gCD matches 60 run title @s actionbar ["",{"text":"[RMB] ","bold":true,"color":"gold"},{"text":"READY","color":"green"}]
execute if score @s dafi.sting.gCD matches 60 run scoreboard players set @s dafi.offhandReady 1
execute if score @s dafi.sting.gCD matches 60 run tag @s remove dafi.offhandProcessed
execute if score @s dafi.sting.gCD matches 60.. run scoreboard players reset @s dafi.sting.gCD
...
## DEATHCHECK
execute if score @s dafi.deathcheck matches 1 if score @s dafi.sting.gCD matches 1.. run scoreboard players set @s dafi.sting.gCD 59
...
## ITEM 2
#item replace entity @s[scores={dafi.sting.gCD=60,dafi.sting.rotate=1},team=red] weapon.offhand with minecraft:snowball{red:1,display:{Name:'[{"text":"Pondering Orb","italic":false,"color":"yellow"}]'}}
#item replace entity @s[scores={dafi.sting.gCD=60,dafi.sting.rotate=1},team=blue] weapon.offhand with minecraft:snowball{blue:1,display:{Name:'[{"text":"Pondering Orb","italic":false,"color":"yellow"}]'}}
# item replace entity @s[scores={dafi.sting.gCD=60,dafi.sting.rotate=2}] weapon.offhand with minecraft:splash_potion{CustomPotionEffects:[{Id:26,Amplifier:0,Duration:160,ShowParticles:0b}],CustomPotionColor:16300586,display:{Name:'[{"text":"Stim Splash","italic":false,"color":"green"}]'},HideFlags:63}
#item replace entity @s[scores={dafi.sting.gCD=60,dafi.sting.rotate=2},team=red] weapon.offhand with minecraft:egg{red:2,display:{Name:'[{"text":"Sting Shell","italic":false,"color":"red"}]'}}
#item replace entity @s[scores={dafi.sting.gCD=60,dafi.sting.rotate=2},team=blue] weapon.offhand with minecraft:egg{blue:2,display:{Name:'[{"text":"Sting Shell","italic":false,"color":"red"}]'}}

## SOUND 2
#execute at @s[scores={dafi.sting.gCD=60}] run playsound minecraft:entity.shulker.open master @a[distance=..10] ~ ~ ~ 6000 1 1

## SOUND
## TITLE
#title @s[scores={dafi.sting.gCD=60}] actionbar  ["",{"text":"\u2605 LET'S ROLL \u2605","bold":true,"color":"gold"}]
...
## SCOREBOARD
#scoreboard players set @s[scores={dafi.sting.gCD=60..}] dafi.sting.gCD 0
...
## DEATHCHECK
#scoreboard players set @s[scores={deathcheck=1..,dafi.sting.gCD=1..}] dafi.sting.gCD 59
