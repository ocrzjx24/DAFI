...
scoreboard players set @a[distance=..1.5, team=!blue] dafi.slow.check 1
execute as @e[distance=..1.5, team=!blue] run damage @s 5 minecraft:explosion by @a[tag=dafi.sbsid.owner, limit=1]
