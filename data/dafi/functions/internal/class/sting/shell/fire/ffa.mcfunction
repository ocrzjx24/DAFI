...
scoreboard players set @a[distance=..1.5] dafi.slow.check 1
execute as @a[distance=..1.5] run damage @s 20 minecraft:explosion by @a[tag=dafi.sbsid.owner, limit=1]
