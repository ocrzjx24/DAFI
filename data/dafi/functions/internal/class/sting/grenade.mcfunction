...
# scoreboard players add @e[type=marker, tag=redDebuff] dafi.sting.spectral 1
# scoreboard players add @e[type=marker, tag=blueDebuff] dafi.sting.spectral 1 
kill @e[scores={dafi.sting.spectral=80..}]
# kmns
...
execute at @e[tag=dafi.sting.redMolotov,tag=dafi.sting.centerMolotov,scores={dafi.sting.spectral=12}] run function dafi:internal/class/sting/molotov/redspread2 
execute as @e[tag=dafi.sting.redMolotov,type=armor_stand, nbt={OnGround:1b}] run data modify entity @s Marker set value 1b 
...
execute at @e[tag=dafi.sting.blueMolotov,tag=dafi.sting.centerMolotov,scores={dafi.sting.spectral=12}] run function dafi:internal/class/sting/molotov/bluespread2 
execute as @e[tag=dafi.sting.blueMolotov,type=armor_stand, nbt={OnGround:1b}] run data modify entity @s Marker set value 1b 
