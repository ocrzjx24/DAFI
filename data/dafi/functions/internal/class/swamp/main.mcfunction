...
## CROUCH VS UPRIGHT
execute if score @s dafi.swamp.useEnderPearl matches 1.. at @s if predicate dafi:is_not_sneaking run scoreboard players set @s dafi.swamp.TPTrigger 1
...
# execute if score @s dafi.swamp.TPTrigger matches 1 at @s run effect give @s[scores={dafi.swamp.TPTrigger=1}] minecraft:darkness 2 1 true
