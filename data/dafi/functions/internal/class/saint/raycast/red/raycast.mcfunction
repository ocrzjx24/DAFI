...
scoreboard players set @a[distance=..3,team=!red] delta.addition.magnitude 10000
execute as @a[distance=..3,team=!red] at @s rotated as @a[tag=dafi.saint.this,sort=nearest,limit=1] run function dafi:internal/mechanics/addition/add_motion
