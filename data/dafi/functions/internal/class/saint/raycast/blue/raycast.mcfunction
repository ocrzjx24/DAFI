...
execute as @a[distance=..3,team=!blue] at @s rotated as @a[tag=dafi.saint.this,sort=nearest,limit=1] run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
