...
execute if entity @s[tag=dafi.arrow.ffa] if entity @a[sort=nearest,limit=1,distance=..1000] unless score @a[sort=nearest,limit=1,distance=..1000] dafi.sbsid = @s dafi.sbsid run function dafi:internal/class/saint/arrow/applymotion