...
item replace entity @s hotbar.1 with minecraft:bamboo{spear:1,display:{Name:'[{"text":"Jade Winged","italic":false,"bold":true,"color":"dark_green"},{"text":" Spear","color":"green"}]',Lore:['[{"text":"This is a joke class how...","italic":false,"color":"dark_gray"}]','[{"text":"how did you even select this","italic":false,"color":"dark_gray"}]','[{"text":"have fun I guess...","italic":false,"color":"dark_gray"}]']},Enchantments:[{id:sharpness,lvl:9},{id:smite,lvl:5}]} 1
