...
execute at @e[tag=dafi.storm.helper] as @a[distance=..7.5] at @e[tag=dafi.storm.helper] facing entity @s feet run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
