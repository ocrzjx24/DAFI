...
execute at @s[nbt={Trident:{tag:{tred:1}}}] if entity @a[team=red,tag=dafi.storm.strike,distance=..5] run function dafi:internal/class/storm/strike/redstrike
execute at @s[nbt={Trident:{tag:{tblue:1}}}] if entity @a[team=blue,tag=dafi.storm.strike,distance=..5] run function dafi:internal/class/storm/strike/bluestrike
execute at @s[nbt={Trident:{tag:{tred:1}}}] run function dafi:internal/class/storm/strike/redweak
execute at @s[nbt={Trident:{tag:{tblue:1}}}] run function dafi:internal/class/storm/strike/blueweak
