...
execute if entity @s[tag=dafi.soul.swap.primed] run scoreboard players set @s delta.addition.magnitude 800
execute if entity @s[tag=dafi.soul.swap.primed] at @s rotated ~ 0 run function dafi:internal/mechanics/addition/add_motion
execute if entity @s[tag=dafi.soul.swap.primed] run scoreboard players set @s delta.addition.magnitude 400
execute if entity @s[tag=dafi.soul.swap.primed] at @s rotated ~ -90 run function dafi:internal/mechanics/addition/add_motion
