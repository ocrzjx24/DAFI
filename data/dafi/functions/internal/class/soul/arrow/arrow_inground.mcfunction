...
execute unless block ~0.2 ~ ~ air store result entity @s Motion[0] double -0.001 run scoreboard players get @s dafi.arrow.x
execute unless block ~0.2 ~ ~ air run scoreboard players operation @s dafi.arrow.x *= #constant.-1 dafi.math
execute unless block ~-0.2 ~ ~ air store result entity @s Motion[0] double -0.001 run scoreboard players get @s dafi.arrow.x
execute unless block ~-0.2 ~ ~ air run scoreboard players operation @s dafi.arrow.x *= #constant.-1 dafi.math
execute unless block ~ ~0.2 ~ air store result entity @s Motion[1] double -0.001 run scoreboard players get @s dafi.arrow.y
execute unless block ~ ~0.2 ~ air run scoreboard players operation @s dafi.arrow.y *= #constant.-1 dafi.math
execute unless block ~ ~-0.2 ~ air store result entity @s Motion[1] double -0.001 run scoreboard players get @s dafi.arrow.y
execute unless block ~ ~-0.2 ~ air run scoreboard players operation @s dafi.arrow.y *= #constant.-1 dafi.math
execute unless block ~ ~ ~0.2 air store result entity @s Motion[2] double -0.001 run scoreboard players get @s dafi.arrow.z
