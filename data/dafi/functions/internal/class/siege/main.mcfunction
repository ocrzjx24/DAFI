...
execute if predicate dafi:is_not_sneaking at @s[tag=dafi.siege.fishing] unless entity @e[type=fishing_bobber,tag=dafi.siege.bobberinrange,distance=..30] facing entity @e[type=marker,tag=dafi.siege.targetmarker,limit=1] feet run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
...
execute if predicate dafi:is_sneaking at @s[team=red,tag=dafi.siege.fishing] unless entity @e[type=fishing_bobber,tag=dafi.siege.bobberinrange,distance=..30] as @e[type=marker,tag=dafi.siege.targetmarker] at @s as @a[distance=..5,team=!red] at @s facing entity @e[type=marker,tag=dafi.siege.targetmarker] eyes run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
execute if predicate dafi:is_sneaking at @s[team=blue,tag=dafi.siege.fishing] unless entity @e[type=fishing_bobber,tag=dafi.siege.bobberinrange,distance=..30] as @e[type=marker,tag=dafi.siege.targetmarker] at @s as @a[distance=..5,team=!blue] at @s facing entity @e[type=marker,tag=dafi.siege.targetmarker] eyes run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
...
execute if score @s[scores={dafi.siege.mode=1,dafi.siege.shotgunShots=1..}] dafi.siege.shotgunCD matches 0 run item replace entity @s hotbar.0 with crossbow{display:{Name:'[{"text":".EXE","italic":false,"color":"gray","bold":true},{"text":"CUTIONER","italic":false,"bold":true,"color":"dark_gray"}]',Lore:['[{"text":"death.attack.firework.item","italic":false,"color":"dark_green"}]']},Enchantments:[{id:"quick_charge",lvl:5},{id:"knockback",lvl:1}],Unbreakable:1,ChargedProjectiles:[{id:"minecraft:arrow",Count:1b}],Charged:1b,HideFlags:36} 1

#> dafi.siege.fishingRodCD
scoreboard players remove @s[scores={dafi.siege.fishingRodCD=1..}] dafi.siege.fishingRodCD 1
execute if score @s dafi.siege.fishingRodCD matches 0 run item replace entity @s hotbar.1 with fishing_rod{Unbreakable:1,display:{Name:'[{"text":"MEAT","italic":false,"color":"dark_red","bold":true},{"text":"HOOK","color":"dark_gray"}]',Lore:['[{"text":"ror2 reference","italic":false}]']},Enchantments:[{id:sharpness,lvl:5}],HideFlags:101} 1
#> offhandCheck
