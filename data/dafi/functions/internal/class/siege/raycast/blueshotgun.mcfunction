execute rotated ~ ~ run function dafi:internal/class/siege/raycast/bluefire
...
execute anchored eyes facing ^0 ^1 ^12 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^0.951 ^0.309 ^12 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^-0.951 ^0.309 ^12 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^0.588 ^-0.809 ^12 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^-0.588 ^-0.809 ^12 run function dafi:internal/class/siege/raycast/bluefire

execute anchored eyes facing ^0 ^-1 ^8 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^-0.951 ^-0.309 ^8 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^0.951 ^-0.309 ^8 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^-0.588 ^0.809 ^8 run function dafi:internal/class/siege/raycast/bluefire
execute anchored eyes facing ^0.588 ^0.809 ^8 run function dafi:internal/class/siege/raycast/bluefire
