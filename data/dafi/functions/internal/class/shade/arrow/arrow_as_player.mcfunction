...
execute if entity @s run summon arrow ^ ^0.2 ^ {Tags:["this","fast","dafi.arrow.shade","dafi.arrow.processed",""]}
execute if entity @s run summon arrow ^-0.6 ^0.2 ^ {Tags:["this","fast","dafi.arrow.shade","dafi.arrow.processed",""]}
execute if entity @s run summon arrow ^0.6 ^-0.1 ^ {Tags:["this","fast","dafi.arrow.shade","dafi.arrow.processed",""]}
execute if entity @s run summon arrow ^-0.6 ^-0.1 ^ {Tags:["this","fast","dafi.arrow.shade","dafi.arrow.processed",""]}
