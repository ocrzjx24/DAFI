...
# Player disappears
execute if score @s dafi.shade.drop.cooldown matches 220 at @s run function dafi:internal/class/shade/drop/disappear
# Cancels invisibility with slide
execute if score @s dafi.shade.drop.cooldown matches 120.. if score @s dafi.slide.slideTime matches 1.. run scoreboard players set @s dafi.shade.drop.cooldown 120
# Player reappears
execute if score @s dafi.shade.drop.cooldown matches 120 at @s run function dafi:internal/class/shade/drop/reappear
# Cooldowns
...
execute if score @s dafi.shade.drop.cooldown matches ..220 run scoreboard players remove @s dafi.shade.drop.cooldown 1
