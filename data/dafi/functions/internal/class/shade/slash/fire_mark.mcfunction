...
execute as @s[tag=dafi.blue] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.blue","dafi.shade.raycaster.kill"]}
execute as @s[tag=dafi.red] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.red","dafi.shade.raycaster.kill"]}
execute as @s[tag=dafi.ffa] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.ffa","dafi.shade.raycaster.kill"]}
## distance = #itt * step_size = 80 * 0.25 = 20 blocks
scoreboard players set .itt dafi.raycast 12
