...
execute as @s[team=blue] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.blue","dafi.shade.raycaster.kill"]}
execute as @s[team=red] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.red","dafi.shade.raycaster.kill"]}
execute as @s[team=ffa] run summon marker ~ ~ ~ {Tags:["dafi.shade.raycaster.mark.ffa","dafi.shade.raycaster.kill"]}
