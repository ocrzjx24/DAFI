...
execute if score @s dafi.shade.slash.lifetime matches 1 positioned ~ ~1 ~ rotated ~-120 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
execute if score @s dafi.shade.slash.lifetime matches 1 positioned ~ ~1 ~ rotated ~-120 0 run function dafi:internal/class/shade/drop/disappear_particle
...
execute if score @s dafi.shade.slash.lifetime matches 2 positioned ~ ~1 ~ rotated ~-60 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
...
execute if score @s dafi.shade.slash.lifetime matches 3 positioned ~ ~1 ~ rotated ~0 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
...
execute if score @s dafi.shade.slash.lifetime matches 5 positioned ~ ~1 ~ rotated ~120 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
...
execute if score @s dafi.shade.slash.lifetime matches 6 positioned ~ ~1 ~ rotated ~180 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
...
execute if score @s dafi.shade.slash.lifetime matches 8 positioned ~ ~1 ~ rotated ~-60 0 run function dafi:internal/class/shade/slash/slash_library/slash4/frame_1
