...
execute if entity @s[tag=dafi.blue] at @s as @e[team=!blue,distance=..6.5] at @s run playsound block.end_portal.spawn master @a ~ ~ ~ 0.3 2
...
execute if entity @s[tag=dafi.red] at @s as @e[team=!red,distance=..6.5] at @s run playsound block.end_portal.spawn master @a ~ ~ ~ 0.1 2
...
execute if entity @s[tag=dafi.ffa] at @s as @e[team=!ffa,distance=..6.5] at @s run playsound block.end_portal.spawn master @a ~ ~ ~ 0.1 2
