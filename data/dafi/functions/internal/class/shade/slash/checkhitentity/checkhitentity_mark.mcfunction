...
execute positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[dx=0,tag=!dafi.shade.hit] positioned ~0.4 ~0.4 ~0.4 at @s run playsound entity.generic.hurt master @a ~ ~ ~ 0.5 0.8
...
execute positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[dx=0,tag=!dafi.shade.hit] positioned ~0.4 ~0.4 ~0.4 run scoreboard players set @s hp_dmg 2
