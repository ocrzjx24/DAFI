...
execute if score .itt dafi.raycast <= .itt.particle1.max dafi.raycast if score .itt dafi.raycast >= .itt.particle1.min dafi.raycast run particle dust 1 0 0.518 1.4 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle2.max dafi.raycast if score .itt dafi.raycast >= .itt.particle2.min dafi.raycast run particle dust 0.427 0.098 0.318 1.2 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle3.max dafi.raycast if score .itt dafi.raycast >= .itt.particle3.min dafi.raycast run particle dust 0.22 0.149 0.216 1.0 ~ ~ ~ 0 0 0 0 1 force
...
execute if score .itt dafi.raycast <= .itt.particle4.max dafi.raycast if score .itt dafi.raycast >= .itt.particle4.min dafi.raycast run particle witch ~ ~ ~ 0 0 0 0.3 1 force
execute if score .itt dafi.raycast <= .itt.particle4.max dafi.raycast if score .itt dafi.raycast >= .itt.particle4.min dafi.raycast run particle dust 0.949 0 1 2.0 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle5.max dafi.raycast if score .itt dafi.raycast >= .itt.particle5.min dafi.raycast run particle dust 0.459 0.204 0.584 1.8 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle6.max dafi.raycast if score .itt dafi.raycast >= .itt.particle6.min dafi.raycast run particle dust 0.235 0.133 0.325 1.6 ~ ~ ~ 0 0 0 0 1 force

#execute if score .itt dafi.raycast <= .itt.particle1.max dafi.raycast if score .itt dafi.raycast >= .itt.particle1.min dafi.raycast run particle dust 0.902 0.275 0.957 1.4 ~ ~ ~ 0 0 0 0 1 force
#execute if score .itt dafi.raycast <= .itt.particle2.max dafi.raycast if score .itt dafi.raycast >= .itt.particle2.min dafi.raycast run particle dust 0.337 0.184 0.439 1.2 ~ ~ ~ 0 0 0 0 1 force
#execute if score .itt dafi.raycast <= .itt.particle3.max dafi.raycast if score .itt dafi.raycast >= .itt.particle3.min dafi.raycast run particle dust 0.165 0.145 0.275 1.0 ~ ~ ~ 0 0 0 0 1 force
