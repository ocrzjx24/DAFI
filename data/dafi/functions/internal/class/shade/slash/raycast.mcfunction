...
execute if score .itt dafi.raycast <= .itt.particle1.max dafi.raycast if score .itt dafi.raycast >= .itt.particle1.min dafi.raycast run particle dust 1 0 0.667 2.2 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle2.max dafi.raycast if score .itt dafi.raycast >= .itt.particle2.min dafi.raycast run particle dust 0.533 0.09 0.247 2.0 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle3.max dafi.raycast if score .itt dafi.raycast >= .itt.particle3.min dafi.raycast run particle dust 0.247 0.141 0.165 1.8 ~ ~ ~ 0 0 0 0 1 force

execute if score .itt dafi.raycast <= .itt.particle4.max dafi.raycast if score .itt dafi.raycast >= .itt.particle4.min dafi.raycast run particle dust 0 1 1 2.7 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle5.max dafi.raycast if score .itt dafi.raycast >= .itt.particle5.min dafi.raycast run particle dust 0.098 0.427 0.416 2.5 ~ ~ ~ 0 0 0 0 1 force
execute if score .itt dafi.raycast <= .itt.particle6.max dafi.raycast if score .itt dafi.raycast >= .itt.particle6.min dafi.raycast run particle dust 0.149 0.22 0.2 2.3 ~ ~ ~ 0 0 0 0 1 force
