...
execute if score @s dafi.shade.useWarpedFungusOnAStick matches 1.. if score @s dafi.shade.attackPattern matches 4.. run scoreboard players set @s dafi.shade.attackPattern 1
...
execute if score @s dafi.shade.useWarpedFungusOnAStick matches 10 if score @s dafi.shade.attackPattern matches ..3 run tag @s remove dafi.offhandProcessed
execute if score @s dafi.shade.useWarpedFungusOnAStick matches 10 if score @s dafi.shade.attackPattern matches ..3 run scoreboard players set @s dafi.offhandReady 1
execute if score @s dafi.shade.useWarpedFungusOnAStick matches 10.. if score @s dafi.shade.attackPattern matches ..3 run scoreboard players set @s dafi.shade.useWarpedFungusOnAStick 0
...
#execute if entity @s[advancements={dafi:eye=true}] run scoreboard players add @s dafi.shade.dropNetheriteSword 1
