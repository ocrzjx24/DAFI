...
execute anchored eyes positioned ^ ^ ^ run summon armor_stand ~ ~ ~ {Tags:["dafi.ball"],Invisible:1b,Small:1b,Passengers:[{id:"minecraft:slime",Tags:["dafi.ball"],Silent:1b,Invulnerable:1b,Glowing:1b,CustomNameVisible:1b,Size:2,NoAI:1,CustomName:'{"text":"ball"}'}]}
