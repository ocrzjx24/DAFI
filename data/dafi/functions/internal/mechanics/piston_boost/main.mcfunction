...
execute as @a at @s if score @s dafi.pistonboost matches 1 if block ~ ~-0.3 ~ minecraft:piston rotated 0 -90 run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
...
execute as @a at @s if score @s dafi.pistonboost matches 1 if block ~ ~-0.3 ~ minecraft:piston rotated ~ 0 run function dafi:internal/mechanics/bigpapi_delta/addition/add_motion
