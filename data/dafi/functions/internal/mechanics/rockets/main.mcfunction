...
execute at @a[scores={dafi.firework.CD=2}] run playsound minecraft:entity.generic.explode master @s ~ ~ ~ 1 1
execute at @a[scores={dafi.firework.CD=30}] run playsound minecraft:item.crossbow.loading_end master @s
...
## SCOREBOARD
scoreboard players reset @a[scores={dafi.firework.CD=20..}] dafi.firework.CD
scoreboard players add @a dafi.firework.CD 1
# RESET CHECK
scoreboard players reset @a[nbt={Inventory:[{id:"minecraft:crossbow",tag:{Charged:1b}}]}] dafi.firework.CD