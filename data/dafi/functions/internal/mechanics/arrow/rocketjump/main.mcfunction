...
execute at @e[tag=dafi.arrow.helper] as @a[distance=..7.5] at @e[tag=dafi.arrow.helper] facing entity @s feet run function dafi:internal/mechanics/addition/add_motion
