...
execute as @e[type=marker,tag=dafi.arrow.lineOfSightCheck,limit=1] run function dafi:internal/mechanics/arrowaoe/ffa/close/eyes/fire
execute as @e[type=marker,tag=dafi.arrow.lineOfSightCheck,limit=1] run function dafi:internal/mechanics/arrowaoe/ffa/close/feet/fire
execute as @s[tag=!dafi.arrow.closeDamage] as @e[type=marker,tag=dafi.arrow.lineOfSightCheck,limit=1] run function dafi:internal/mechanics/arrowaoe/ffa/far/eyes/fire
execute as @s[tag=!dafi.arrow.closeDamage] as @e[type=marker,tag=dafi.arrow.lineOfSightCheck,limit=1] run function dafi:internal/mechanics/arrowaoe/ffa/far/feet/fire
