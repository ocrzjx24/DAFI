...
execute as @a[scores={dafi.dash.time=0}] run tp @s @s
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] at @s rotated ~ 0 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle1
#execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] at @s rotated ~ 0 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle2
#execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] at @s rotated ~ 0 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle3
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] run scoreboard players set @s delta.addition.magnitude 16000
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] at @s rotated ~ 0 run function dafi:internal/mechanics/addition/add_motion
...
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] run scoreboard players set @s delta.addition.magnitude 2600
# execute as @a[scores={dafi.dash.time=0}] run scoreboard players operation @s delta.addition.magnitude += @s dafi.dash.y
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] at @s rotated 0 -90 run function dafi:internal/mechanics/addition/add_motion
execute as @a[scores={dafi.dash.time=0},predicate=dafi:is_sneaking] run tag @s add dafi.slide.exempt

execute as @a[scores={dafi.dash.time=0},tag=!dafi.slide.exempt] at @s rotated ~ -20 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle1
#execute as @a[scores={dafi.dash.time=0},tag=!dafi.slide.exempt] at @s rotated ~ -20 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle2
#execute as @a[scores={dafi.dash.time=0},tag=!dafi.slide.exempt] at @s rotated ~ -20 positioned ~ ~1 ~ run function dafi:internal/mechanics/dash/particle3
...
# execute as @a[scores={dafi.dash.time=0},tag=!dafi.saint] store result score @s dafi.dash.y run data get entity @s Motion[1] -10000
execute as @a[scores={dafi.dash.time=0},tag=!dafi.slide.exempt] run scoreboard players set @s delta.addition.magnitude 7200
# execute as @a[scores={dafi.dash.time=0}] run scoreboard players operation @s delta.addition.magnitude += @s dafi.dash.y
