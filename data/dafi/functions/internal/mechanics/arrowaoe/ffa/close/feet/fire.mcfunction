...
execute anchored feet positioned ^ ^ ^ facing entity @e[type=!marker,tag=dafi.arrow.init] feet as @e[type=marker,tag=dafi.arrow.raycaster,tag=dafi.arrow.closeFeet] run function dafi:internal/mechanics/arrowaoe/ffa/close/feet/raycast
