...
execute if score .itt dafi.arrow.raycast matches 1.. if block ~ ~ ~ #dafi:air positioned ^ ^ ^0.1 run function dafi:internal/mechanics/arrowaoe/blue/close/eyes/raycast
