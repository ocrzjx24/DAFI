...
execute anchored feet positioned ^ ^ ^ facing entity @e[type=!marker,tag=dafi.arrow.Init] feet as @e[type=marker,tag=dafi.arrow.Raycaster,tag=dafi.arrow.CloseFeet] run function dafi:internal/mechanics/arrowaoe/red/close/feet/raycast
