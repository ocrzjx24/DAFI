...
execute anchored eyes positioned ^ ^ ^ facing entity @e[type=!marker,tag=dafi.arrow.init] eyes as @e[type=marker,tag=dafi.arrow.raycaster,tag=dafi.arrow.closeEyes] run function dafi:internal/mechanics/arrowaoe/red/close/eyes/raycast
