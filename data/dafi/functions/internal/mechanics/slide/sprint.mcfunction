...
execute if score @s dafi.slide.sprintTime matches 5 at @s run playsound minecraft:block.note_block.hat master @s ~ ~100 ~ 1000 0.6
execute if score @s dafi.slide.sprintTime matches 10.. run effect give @s speed 999999 1 true
execute if score @s dafi.slide.sprintTime matches 10 at @s run playsound minecraft:block.note_block.hat master @s ~ ~100 ~ 1000 0.75
execute if score @s dafi.slide.sprintTime matches 15.. run effect give @s speed 999999 2 true
execute if score @s dafi.slide.sprintTime matches 15 at @s run playsound minecraft:block.note_block.hat master @s ~ ~100 ~ 1000 1

execute if score @s dafi.slide.sprintTime matches 15.. if data entity @s {OnGround:1b} if predicate dafi:is_sneaking at @s run function dafi:internal/mechanics/slide/slide
execute if score @s dafi.slide.slideTime matches 1.. run scoreboard players set @s delta.addition.magnitude 3000
...
execute if score @s dafi.slide.slideTime matches 1.. if predicate dafi:is_sneaking at @s run particle electric_spark ~ ~ ~ 0 0 0 0.75 3 normal
