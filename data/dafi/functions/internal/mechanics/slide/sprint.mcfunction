...
execute if score @s dafi.slide.sprintTime matches 6.. if data entity @s {OnGround:1b} if predicate dafi:is_sneaking at @s run function dafi:internal/mechanics/slide/slide
