...
execute if score @s dafi.slide.sprintTime matches 5 at @s run playsound minecraft:block.note_block.hat master @s ~ ~1000 ~ 0.25 0.6 0.25
#execute if score @s dafi.slide.sprintTime matches 10.. run effect give @s speed 999999 1 true
execute if score @s dafi.slide.sprintTime matches 10 at @s run playsound minecraft:block.note_block.hat master @s ~ ~1000 ~ 0.25 0.75 0.25
#execute if score @s dafi.slide.sprintTime matches 15.. run effect give @s speed 999999 2 true
execute if score @s dafi.slide.sprintTime matches 15 at @s run playsound minecraft:block.note_block.hat master @s ~ ~1000 ~ 0.25 1 0.25
