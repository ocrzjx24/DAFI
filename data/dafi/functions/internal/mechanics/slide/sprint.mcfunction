...
execute if score @s dafi.slide.sprintTime matches 1.. unless score #universal dafi.slide.stamina matches 1.. if score @s dafi.slide.stamina matches 40.. if data entity @s[tag=!dafi.slide_exempt] {OnGround:1b} if predicate dafi:is_sneaking at @s run function dafi:internal/mechanics/slide/slide
execute if score @s dafi.slide.sprintTime matches 1.. if score #universal dafi.slide.stamina matches 1 if score @s dafi.slide.stamina matches 20.. if data entity @s[tag=!dafi.slide_exempt] {OnGround:1b} if predicate dafi:is_sneaking at @s run function dafi:internal/mechanics/slide/slide
execute if score @s dafi.slide.sprintTime matches 1.. if score #universal dafi.slide.stamina matches 2 if score @s dafi.slide.stamina matches 40.. if data entity @s[tag=!dafi.slide_exempt] {OnGround:1b} if predicate dafi:is_sneaking at @s run function dafi:internal/mechanics/slide/slide
...
tag @s[tag=dafi.slide_exempt] remove dafi.slide_exempt
