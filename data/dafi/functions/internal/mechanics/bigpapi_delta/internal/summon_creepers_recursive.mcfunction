## > delta:internal/summon_creepers_recursive
...
execute if score $creepers_remaining delta.internal.math matches 1.. run function dafi:internal/mechanics/bigpapi_delta/internal/summon_creepers_recursive