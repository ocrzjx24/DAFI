...
advancement revoke @s only dafi:post_explosion_trigger
...
execute as @e[tag=delta.shifted] at @s run function dafi:internal/mechanics/bigpapi_delta/internal/unshift_entity
execute as @a[tag=delta.ignored_player] run function dafi:internal/mechanics/bigpapi_delta/internal/end_ignore_player