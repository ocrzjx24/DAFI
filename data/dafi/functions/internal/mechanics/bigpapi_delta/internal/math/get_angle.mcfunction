...
function dafi:internal/mechanics/bigpapi_delta/internal/math/get_power_coefficient
...
function dafi:internal/mechanics/bigpapi_delta/internal/math/sqrt
...
execute as @e[type=marker,tag=delta.temp_marker,limit=1] at @s run function dafi:internal/mechanics/bigpapi_delta/internal/math/arcsin_wrapper