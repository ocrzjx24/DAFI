...
execute as @e[type=marker,tag=delta.xyz_helper] run function dafi:internal/mechanics/bigpapi_delta/internal/math/xyz_to_polar_wrapper

#Launch
execute rotated as @e[type=marker,tag=delta.xyz_helper] run function dafi:internal/mechanics/bigpapi_delta/api/launch_looking
