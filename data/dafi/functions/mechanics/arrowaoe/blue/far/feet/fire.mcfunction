...
scoreboard players set .abffitt raycast 30

## temporary tag to remember who fired the raycast
tag @s add this

## anchors raycast starting position to the eyes
execute anchored feet positioned ^ ^ ^ facing entity @e[type=!marker,tag=arrowInit] feet as @e[type=marker,tag=arrowRaycaster,tag=arrowFarFeet] run function dafi:mechanics/arrowaoe/blue/far/feet/raycast
