...
scoreboard players set .abceitt raycast 15

## temporary tag to remember who fired the raycast
tag @s add this

## anchors raycast starting position to the eyes
execute anchored eyes positioned ^ ^ ^ facing entity @e[type=!marker,tag=arrowInit] eyes as @e[type=marker,tag=arrowRaycaster,tag=arrowCloseEyes] run function dafi:mechanics/arrowaoe/blue/close/eyes/raycast
