...
scoreboard players set .arcfitt raycast 15

## temporary tag to remember who fired the raycast
tag @s add this

## anchors raycast starting position to the eyes
execute anchored feet positioned ^ ^ ^ facing entity @e[type=!marker,tag=arrowInit] feet as @e[type=marker,tag=arrowRaycaster,tag=arrowCloseFeet] run function dafi:mechanics/arrowaoe/red/close/feet/raycast
