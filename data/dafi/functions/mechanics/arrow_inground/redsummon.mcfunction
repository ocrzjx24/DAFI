...
execute as @e[type=marker,tag=lineOfSightCheck,limit=1] run function dafi:mechanics/arrowaoe/red/close/eyes/fire
execute as @e[type=marker,tag=lineOfSightCheck,limit=1] run function dafi:mechanics/arrowaoe/red/close/feet/fire
execute as @s[tag=!closeDamage] as @e[type=marker,tag=lineOfSightCheck,limit=1] run function dafi:mechanics/arrowaoe/red/far/eyes/fire
execute as @s[tag=!closeDamage] as @e[type=marker,tag=lineOfSightCheck,limit=1] run function dafi:mechanics/arrowaoe/red/far/feet/fire
