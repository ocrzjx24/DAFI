...
execute as @e[tag=wallCast,tag=blueWall] at @s run scoreboard players set @a[distance=..1,team=!blue] delta.addition.magnitude 3000
execute as @e[tag=wallCast,tag=blueWall] at @s as @a[distance=..1,team=!blue] at @s rotated as @e[limit=1,tag=wallCast] run function dafi:mechanics/bigpapi_delta/addition/add_motion

execute as @e[tag=wallCast,tag=redWall] at @s run scoreboard players set @a[distance=..1,team=!red] delta.addition.magnitude 3000
execute as @e[tag=wallCast,tag=redWall] at @s as @a[distance=..1,team=!red] at @s rotated as @e[limit=1,tag=wallCast] run function dafi:mechanics/bigpapi_delta/addition/add_motion
