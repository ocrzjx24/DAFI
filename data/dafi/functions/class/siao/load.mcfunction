setblock 0 -64 0 shulker_box destroy
scoreboard objectives add dropBamboo minecraft.dropped:minecraft.bamboo
scoreboard objectives add baneOfAllEvil dummy
