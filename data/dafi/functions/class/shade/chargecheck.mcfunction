...
execute if score @s chargeCheck matches 0 if score @s charge matches 1..4 run scoreboard players set @s charge -1
execute if score @s chargeCheck matches 0 if score @s charge matches 1..11 run scoreboard players set @s charge 0
