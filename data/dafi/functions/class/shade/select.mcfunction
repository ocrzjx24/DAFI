...
item replace entity @s inventory.0 with skull_banner_pattern{display:{Name:'[{"text":"SHADE ","italic":false,"bold":true,"color":"light_purple"},{"text":"| "},{"text":"Occult Assassin","bold":false}]',Lore:['[{"text":"\\"Shimmering water, under moonlight.\\"","italic":false}]','[{"text":"To strike a deal with a demon was akin to","italic":false,"color":"dark_green"}]','[{"text":"making a deathwish, though perhaps it\'s","italic":false,"color":"dark_green"}]','[{"text":"what they wanted. What they received was","italic":false,"color":"dark_green"}]','[{"text":"an ever-fleeting existence and an unlikely","italic":false,"color":"dark_green"}]','[{"text":"friendship.","italic":false,"color":"dark_green"}]']}} 1
