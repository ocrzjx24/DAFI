...
execute at @s[scores={dropNSword=1}] run playsound minecraft:entity.evoker.cast_spell master @a ~ ~ ~ 1 1.8
execute at @s[scores={dropNSword=1}] run playsound minecraft:entity.player.attack.sweep master @a ~ ~ ~ 1 1
