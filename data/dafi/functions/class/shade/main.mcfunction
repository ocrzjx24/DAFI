...
execute at @s[scores={dropNSword=1}] run playsound minecraft:block.soul_sand.place master @a[distance=..10] ~ ~ ~ 1 1.5
execute at @s[scores={dropNSword=1}] run playsound minecraft:entity.evoker.cast_spell master @a[distance=..10] ~ ~ ~ 1 1
execute at @s[scores={dropNSword=1}] run playsound minecraft:entity.allay.ambient_with_item master @a[distance=..10] ~ ~ ~ 1 2
...
execute at @s[scores={dropNSword=60}] run playsound minecraft:block.ender_chest.open master @a[distance=..10] ~ ~ ~ 1 1.3
execute at @s[scores={dropNSword=60}] run playsound minecraft:entity.allay.ambient_with_item master @a[distance=..10] ~ ~ ~ 1 1.2
