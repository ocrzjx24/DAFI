...
item replace entity @s inventory.0 with skull_banner_pattern{display:{Name:'[{"text":"SIEGE ","italic":false,"bold":true,"color":"gray"},{"text":"| "},{"text":"Unstoppable Machine","bold":false}]',Lore:['[{"text":"\\"TARGET ACQUIRED. RECALCULATING.","italic":false}]','[{"text":"TARGET ANNIHILATED.\\"","italic":false}]','[{"text":"A walking gatling gun, mass produced for","italic":false,"color":"dark_green"}]','[{"text":"war. It\'s almost cute how primitive this","italic":false,"color":"dark_green"}]','[{"text":"machine is compared to the otherworldly","italic":false,"color":"dark_green"}]','[{"text":"abilities of others. But a cold heart and","italic":false,"color":"dark_green"}]','[{"text":"plenty of bullets can still tear you","italic":false,"color":"dark_green"}]','[{"text":"to shreds.","italic":false,"color":"dark_green"}]']}} 1
