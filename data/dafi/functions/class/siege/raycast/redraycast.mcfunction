particle dust 1 0 0 0.5 ~ ~ ~ 0 0 0 0 1
...
execute positioned ~-0.05 ~-0.05 ~-0.05 as @e[type=#dafi:entities_raycast,team=!red,tag=!this,dx=0] run function dafi:class/siege/raycast/redcheckhitentity