summon marker ~ ~ ~ {Tags:["saintRedRaycaster"]}
...
execute anchored eyes positioned ^ ^ ^ as @e[type=marker,tag=saintRedRaycaster] run function dafi:class/saint/raycast/red/raycast
...
kill @e[type=marker,tag=saintRedRaycaster]