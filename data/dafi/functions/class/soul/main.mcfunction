...
title @s[nbt={Inventory:[{Slot:100b,id:"minecraft:golden_boots"}]},scores={reaver=1..}] actionbar {"text":"\u2605 SOULSTEAL \u2605","bold":true,"color":"#ffd814"}
...
title @s[scores={dropReaver=1}] actionbar {"text":"WOOSH","bold":true,"color":"#ffd814"}
...
title @s[scores={killcheck=1}] actionbar {"text":"\u2605 SOULSTEAL \u2605","bold":true,"color":"#ffd814"}
