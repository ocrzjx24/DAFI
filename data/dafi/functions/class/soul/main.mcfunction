...
execute if score @s reaver matches 1 at @s run particle minecraft:soul_fire_flame ~ ~1 ~ 0.2 0.2 0.2 0.1 10 normal
...
execute if score @s dropReaver matches 1..20 at @s run particle soul_fire_flame ~ ~ ~ 0.1 0.1 0.1 0.1 1 force
