...
item replace entity @s inventory.1 with paper{display:{Name:'[{"text":"Agility ","italic":false,"color":"yellow","bold":true},{"text":"| ","color":"white"},{"text":"PASSIVE","color":"white","bold":true}]',Lore:['[{"text":"SOUL has a passive speed buff","italic":false,"color":"dark_green"}]','[{"text":"compared to the other classes.","italic":false,"color":"dark_green"}]']}} 1
item replace entity @s inventory.2 with paper{display:{Name:'[{"text":"Soulsteal ","italic":false,"color":"yellow","bold":true},{"text":"| ","color":"white"},{"text":"PASSIVE","color":"white","bold":true}]',Lore:['[{"text":"Upon killing an opponent,","italic":false,"color":"dark_green"}]','[{"text":"SOUL gains a speed boost","italic":false,"color":"dark_green"}]','[{"text":"and healing bonus.","italic":false,"color":"dark_green"}]']}} 1
