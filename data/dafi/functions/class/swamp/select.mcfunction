...
item replace entity @s inventory.0 with skull_banner_pattern{display:{Name:'[{"text":"SWAMP","italic":false,"bold":true,"color":"#996633"},{"text":" ","color":"gray"},{"text":"| ","color":"gray"},{"text":"Delusional Monster","color":"gray","bold":false}]',Lore:['[{"text":"\\"Fear me.\\"","italic":false}]','[{"text":"The scientists did not understand what","italic":false,"color":"dark_green"}]','[{"text":"they had created. It seemed so afraid","italic":false,"color":"dark_green"}]','[{"text":"of them. But their last shouts were","italic":false,"color":"dark_green"}]','[{"text":"also of terror before drowning in the","italic":false,"color":"dark_green"}]','[{"text":"mud. ","italic":false,"color":"dark_green"}]']}} 1
