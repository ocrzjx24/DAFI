...
execute as @e[scores={roarLife=1..}] at @s anchored eyes run function dafi:class/shade/castparticle
# execute at @e[scores={roarLife=1..},tag=blueSword] run tag @e[distance=..3,team=!blue,tag=!swordCast] add markedByBlue
