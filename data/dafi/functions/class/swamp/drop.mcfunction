## GIVE WOODEN AXE
item replace entity @s hotbar.1 with wooden_axe{display:{Name:'[{"text":"Maul","italic":false,"bold":true,"color":"dark_red"},{"text":"| ","color":"dark_gray","bold":false},{"text":"[","color":"white","bold":false},{"text":"⌛","color":"gray","bold":false},{"text":"]","bold":false,"color":"white"},{"text":"/","bold":false,"color":"dark_gray"},{"text":"[","bold":false,"color":"white"},{"text":"⌛","color":"gray","bold":false},{"text":"]","bold":false,"color":"white"}]',Lore:['[{"text":"It\'s maulin\' time.","italic":false,"color":"green"}]']},Unbreakable:1,HideFlags:3,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:10,Operation:0,UUID:[I;1014886342,1084823496,1064780877,1393545524]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-0.2,Operation:2,UUID:[I;1014886342,1084823496,1064780877,1393545524]}],Enchantments:[{id:"minecraft:thorns",lvl:1}]} 1
