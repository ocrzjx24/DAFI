...
## ITEM 2
item replace entity @s[scores={gCD=80,rotate=1},team=red] weapon.offhand with minecraft:snowball{red:1,display:{Name:'[{"text":"Stellar Sonar","italic":false,"color":"yellow"}]'}}
item replace entity @s[scores={gCD=80,rotate=1},team=blue] weapon.offhand with minecraft:snowball{blue:1,display:{Name:'[{"text":"Stellar Sonar","italic":false,"color":"yellow"}]'}}
...
item replace entity @s[scores={gCD=80,rotate=3},team=red] weapon.offhand with minecraft:egg{red:2,display:{Name:'[{"text":"Sting Shell","italic":false,"color":"red"}]'}}
item replace entity @s[scores={gCD=80,rotate=3},team=blue] weapon.offhand with minecraft:egg{blue:2,display:{Name:'[{"text":"Sting Shell","italic":false,"color":"red"}]'}}
