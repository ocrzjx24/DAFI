## LOAD
scoreboard players add @s[scores={dropMCTNT=1..}] dropMCTNT 1
clear @s[scores={dropMCTNT=2}] minecraft:crossbow
execute at @s[scores={dropMCTNT=2..19}] run function dafi:class/slay/stand2
...
title @s[scores={dropMCTNT=19}] actionbar {"text":"LOCK 'N LOAD","bold":true,"color":"red"}
title @s[scores={slayCD=119}] actionbar {"text":"\u2605 TRIGGER FINGER TWITCHES \u2605","bold":true,"color":"red"}
scoreboard players reset @s[scores={slayCD=120..}] slayCD
...
scoreboard players set @s[scores={dropMCTNT=1..,deathcheck=1}] slayCD 119
scoreboard players reset @s[scores={dropMCTNT=1..,deathcheck=1}] dropMCTNT
